...
async function exportTokens() {
  ...
  const data = {
    '/': 'Generated by Nimbus, you can import it to Nimbus to restore the tokens.',
  ...
  saveAs(blob, `nimbus-users-tokens-${new Date().toISOString().slice(0, 10)}.json`)
}
...
async function importTokens() {
  ...
  try {
    ...
    console.error(e)
    alert('Invalid Nimbus tokens file')
  }
}
</script>
